...
class AlignerTest(unittest.TestCase):
    ...
    def setUp(self):
        self.aligner = Aligner(use_cfa=True)
    ...
    def test_align_and_extract_images(self):
        ...
        cases = [
            ...
            ('104.jpg', 1, (128, 128), (.58, .58)),
            ('295.jpg', 1, (128, 128), (.58, .58)),
            ('moetron.jpg', 1, (128, 128), (.58, .58)),

            # # multiple face images
            ('222.jpg', 2, (128, 128), (.58, .58)),
            ('158.jpg', 2, (128, 128), (.58, .58)),
